...
type ProjectMetadata struct {
	...
	// Whether content trust is enabled or not. If it is enabled, user cant pull unsigned images from this project. The valid values are 'true', 'false'.
	EnableContentTrust *string `json:"enable_content_trust,omitempty"`

	// Whether cosign content trust is enabled or not. If it is enabled, user cant pull images without cosign signature from this project. The valid values are 'true', 'false'.
	...
	// If the vulnerability is high than severity defined here, the images cant be pulled. The valid values are 'none', 'low', 'medium', 'high', 'critical'.
