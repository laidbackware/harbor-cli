...
type CVEAllowlist struct {
	...
	// the time for expiration of the allowlist, in the form of seconds since epoch.  This is an optional attribute, if its not set the CVE allowlist does not expire.
