...
/*
  ...
  Get the artifact icon with the specified digest. As the original icon image is resized and encoded before returning, the parameter 'digest' in the path doesnt match the hash of the returned content
*/
